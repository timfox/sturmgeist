...
if(BUILD_CLIENT)
	...
	if(FEATURE_IMGUI)
		...
		if(BUNDLED_IMGUI)
			...
			# Ensure cimgui exposes full enums/structs and provide compatibility for igGetIO()
			target_compile_definitions(client_libraries INTERFACE CIMGUI_DEFINE_ENUMS_AND_STRUCTS igGetIO=igGetIO_Nil)
			target_compile_definitions(renderer_libraries INTERFACE CIMGUI_DEFINE_ENUMS_AND_STRUCTS igGetIO=igGetIO_Nil)
		else()
